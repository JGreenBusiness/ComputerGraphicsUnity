...
namespace UnityTemplateProjects
{
    public static class MeshGenerator
    {
        ...
        private static void CreateVertex(ref Vector3[] _verts, ref Vector2[] _uvs,
            ref Vector3[] _normals, float3 _position, int _density, int _index)
        {
            _verts[_index] = _position;
            _uvs[_index] = new Vector2
            {
                x = _position.x / (float) _density,
                y = _position.y / (float) _density
            };
